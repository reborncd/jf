                        ...
                        <div class="fr">
                            ...
                            <div class="search i-b" >
                                <el-input
                                        ...
                                        size="mini"
                                        clearable
                                        @keyup.13="searchKeyword" @change="searchKeyword"
                                >
                                </el-input>
                            </div>
                        </div>
                    ...
                    <div class="console-tab-wrapper" v-if="tabs.consoleWrapperVisible">
                        <div class="console-action-wrapper">
                            ...
                            <div class="console-action fr" v-if="tabs.consoleActionVisible">
                                <span v-for="item in tabs.consoleActionData.jckf" @click="consoleActionEvent(item,'jckf')">{{item}}</span>
                            </div>
                        </div>
                            ...
                            <el-tab-pane label="详情页" name="info">
                                <div class="console-tab-content">
                                    <el-form label-width = "100px" label-position="left">
                                        <el-row :gutter="20">
                                            <el-col :span="24"><el-form-item label="状态">{{tabs.data_one.state_NAME}}</el-form-item></el-col>
                                            <el-col :span="12"><el-form-item label="需求编号">{{tabs.data_one.base_NEET_ID}}</el-form-item></el-col>
                                            <el-col :span="12"><el-form-item label="申请人">{{tabs.data_one.apply_NAME}}</el-form-item></el-col>
                                            <el-col :span="12"><el-form-item label="需求名称">{{tabs.data_one.neel_NAME}}</el-form-item></el-col>
                                            <el-col :span="12"><el-form-item label="需求来源">{{tabs.data_one.user_NAME}}</el-form-item></el-col>
                                            <el-col :span="12"><el-form-item label="申请日期">{{tabs.data_one.start_DATE}}</el-form-item></el-col>
                                            <el-col :span="12"><el-form-item label="计划投产日期">{{tabs.data_one.end_DATE}}</el-form-item></el-col>
                                            <el-col :span="12"><el-form-item label="优先级">{{tabs.data_one.rriority_NAME}}</el-form-item></el-col>
                                            <el-col :span="12"><el-form-item label="重要程度">{{tabs.data_one.importance_NAME}}</el-form-item></el-col>
                                            <el-col :span="24">
                                                <el-form-item label="是否加急"><span style="margin-right: 40px;">{{tabs.data_one.jiaji}}</span><span>{{tabs.data_one.urgent}}</span></el-form-item>
                                            </el-col>
                                            <el-col :span="24"><el-form-item label="需求描述">{{tabs.data_one.neel_DESCRIPTION}}</el-form-item></el-col>
                                            <el-col :span="24"><el-form-item label="产品功能">{{tabs.data_one.product_FUNCTION}}</el-form-item></el-col>
                                        </el-row>
                                    </el-form>
                                </div>
                            </el-tab-pane>
            ...
            <el-form label-width="100px">
                <el-row :md="24" :gutter="20">
                    ...
                    <el-col :span="12" :md="12">
                        <el-form-item label="需求编号"><el-input v-model="addneeds.addform.code" disabled></el-input></el-form-item>
                    </el-col>
                    <el-col :span="12" :md="12">
                        <el-form-item label="需求名称"><el-input v-model="addneeds.addform.name"></el-input></el-form-item>
                    </el-col>
                    <el-col :span="12" :md="12"><el-form-item label="申请人"><el-input v-model="addneeds.addform.sxname" ></el-input></el-form-item></el-col>
                    <el-col :span="12" :md="12">
                        <el-form-item label="需求来源">
                            <el-select v-model="addneeds.addform.fromdeptId" clearable  placeholder="请选择需求来源" style="width: 49%;float: left;margin-right: 2%;" @change="fromdeptchange">
                                <el-option v-for="item in addneeds.addform.fromdeptArr" :label="item.dept_name" :value="item.dept_id"></el-option>
                            </el-select>
                            <el-select v-model="addneeds.addform.fromdeptroleId" clearable placeholder="请选择人员" style="width: 49%;float: left;">
                                <el-option v-for="item in addneeds.addform.fromdeptroleArr" :label="item.user_NAME" :value="item.user_ID"></el-option>
                            </el-select>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12" :md="12">
                        <el-form-item label="申请日期"><el-date-picker type="date" placeholder="选择日期" v-model="addneeds.addform.shenqingdate" style="width: 100%;"></el-date-picker></el-form-item>
                    </el-col>
                    <el-col :span="12" :md="12">
                        <el-form-item label="计划投产日期"><el-date-picker type="date" placeholder="选择日期" v-model="addneeds.addform.jihuadate" style="width: 100%;"></el-date-picker></el-form-item>
                    </el-col>
                    <el-col :span="12" :md="12">
                    ...
                    <el-col :span="24" :md="24">
                        <el-form-item label="产品功能"><el-input v-model="addneeds.addform.gongneng"></el-input></el-form-item>
                    </el-col>
                    <el-col :span="24" :md="24">
                        <el-form-item label="需求描述"><el-input type="textarea" v-model="addneeds.addform.needsname"></el-input></el-form-item>
                    </el-col>
                </el-row>
            </el-form>
            ...
            handleCurrentChange(val){
                ...
                if(val.base_NEET_ID){
                    ...
                    this.$axios.post("/base/queryBaseMessage",params).then((res)=>{
                        ...
                        if(data.code ==200){
                            //以下是设置展示数据
                            let start = this.$format(data.result.start_DATE);
                            let end = this.$format(data.result.end_DATE);
                            this.tabs.data_one.state_NAME = data.result.state_NAME;
                            this.tabs.data_one.apply_NAME = data.result.apply_NAME;
                            this.tabs.data_one.base_NEET_ID = data.result.base_NEET_ID;
                            this.tabs.data_one.importance_NAME = data.result.importance_NAME;
                            this.tabs.data_one.neel_DESCRIPTION = data.result.neel_DESCRIPTION;
                            this.tabs.data_one.neel_NAME = data.result.neel_NAME;
                            this.tabs.data_one.product_FUNCTION = data.result.product_FUNCTION;
                            this.tabs.data_one.rriority_NAME = data.result.rriority_NAME;
                            this.tabs.data_one.urgent = data.result.urgent;
                            if(!data.result.dept_NAME || !data.result.user_NAME){
                                this.tabs.data_one.user_NAME = "";
                            }else{
                                this.tabs.data_one.user_NAME = data.result.dept_NAME+"  ——  "+ data.result.user_NAME;
                            }
                            this.tabs.data_one.jiaji = data.result.urgent?'是':'否';
