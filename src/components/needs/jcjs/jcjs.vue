              ...
              <el-tab-pane label="操作台" name="console" v-if="split.hasSplitTaskDataByGroup">
                <div class="console-tab-content">
                  ...
                  <div v-if="split.splitvisible">
                    ...
                    <div class="clear">
                      <el-button style="float: none;margin: 10px auto;display: block" size="mini"
                                 type="primary" @click="splitSubmit">提交
                      </el-button>
                    </div>
                  </div>
                  <!--技术管理部评审-->
                  <el-form style="margin-top: 20px;" v-if="ifPing.visible" label-width="120px" label-position="left">
                    <el-row :gutter="20">
                      <el-col :span="12">
                        <el-form-item label="优先级评定">
                          <el-select v-model="ifPing.rriority" filterable clearable placeholder="请选择优先级评定"
                                     style="width: 100%">
                      ...
                      <el-col :span="12">
                        <el-form-item label="评审时间">
                          <el-date-picker type="date" placeholder="选择评审日期" v-model="ifPing.date"
                    ...
                    <el-row :gutter="20">
                      <el-col :span="24">
                        <el-button style="display: block;margin: 10px auto;" @click="subPing" size="mini"
                                   type="primary">提交审批
                        </el-button>
                      </el-col>
                    </el-row>
                    ...
                    <el-row :span="24" :gutter="20" style="margin-top: 20px;">
                      <el-col :span="12" :md="12">
                        <el-form-item label="预计开始时间">
                          <el-date-picker type="date" placeholder="选择日期" v-model="review.startDate"
                                          style="width: 100%;"></el-date-picker>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12" :md="12">
                        <el-form-item label="预计完成时间">
                          <el-date-picker type="date" placeholder="选择日期" v-model="review.endDate"
                                          style="width: 100%;"></el-date-picker>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12" :md="12">
                        <el-form-item label="分析时间">
                          <el-date-picker type="date" placeholder="选择日期" v-model="review.fxDate"
                                          style="width: 100%;"></el-date-picker>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12" :md="12">
                  ...
                  <div v-if="changeInset.visible">
                    ...
                    <div class="table-list">
                      ...
                      <div style="text-align: center;margin-top: 20px;">
                        <el-button style="float: none" type="primary" size="mini" @click="subChangeInset">确认变更
                        </el-button>
                      </div>
                    </div>
                  </div>
        ...
        <el-row :md="24" :gutter="20">
          ...
          <el-col :span="12" :md="12">
            <el-form-item label="申请日期">
              <el-date-picker :disabled="addneeds.addType == 'changeInset'" type="date" placeholder="选择日期"
      ...
      <div class="assign-wrapper" v-if="assign.left">
        ...
        <ul v-if="!assign.leftSearch">
          <li v-for="(item, index) in assign.searchData" v-if="item.users.length>0">
            <span class="deptTitle" @click="assign.assignDeptIndex = index"
                  style="cursor: pointer">{{item.dept_name}}</span>
    ...
    <el-dialog title="新增拆分任务人员" :visible="split.splitaddvisible" width="60%"
      ...
      <el-form label-width="100px">
        ...
        <el-form-item label="系统名">
          <el-col :span="24">
            <el-radio v-model="split.splitradio" label="1" @change="split.choosesystem = '';split.levelchoosen = '';">
              测试任务
            </el-radio>
            <el-radio v-model="split.splitradio" label="2" @change="split.choosesystem = '';split.levelchoosen = '';">
              开发任务
            </el-radio>
