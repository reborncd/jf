            ...
            <div class="text item">
                <div class="content" v-if="!errorVisible">
                    <div class="action clear">
                        <el-button type="danger" @click="errorVisible = !errorVisible">提交故障</el-button>
    ...
    export default {
        ...
        methods: {
            ...
            calculateTableHeight(type){
                ...
                //0代表没有控制台
                if (type == 0) {
                    this.table.tableHeight = height - actionHeight - card_header_height - 20 - 36 - 40 ;
                } else {
            ...
            calculateTabsHeight(){
                ...
                for (let i of allTabContent) {
                    //---------------el-card__body的可用内容高(增加一个范围容差)---------顶部操作栏的高---------表格部分的高------tab的头和margin的高---操作台border
                    i.style.height = (parseInt(card_body.style.height) - 40) - actionHeight - (this.table.tableHeight + 20) - (20 + 40)-2 + "px";
                }
            },
            searchKeyword(e){
                if (e.keyCode == 13) {
